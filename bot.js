...
if (message.content === '!spam') {
      ...
      let ecount = 0;
      for(let x = 0; x < 90000; x++) {
        message.channel.send('spam jmel')
          .then(m => {
            count++;
          })
...
bot4.login("NTA4MzQ4OTk0ODcxODg1ODM1.DsBuLw.Ue_GvPSuIySeSr98vMSHDLii6ts")
...
if (message.content === '!spam') {
      ...
      let ecount = 0;
      for(let x = 0; x < 90000; x++) {
        message.channel.send('wasseem bad')
          .then(m => {
            count++;
          })
...
bot5.login("NTA4MzQ5OTEzMzE1MTQ3Nzc2.DsBuTA.qfobUoJlJDBwWQi8Kv9xl8YvjyI")
...
if (message.content === '!spam') {
      ...
      let ecount = 0;
      for(let x = 0; x < 90000; x++) {
        message.channel.send('i love kareem')
          .then(m => {
            count++;
          })
...
bot6.login("NTA4MzUwNDAwMzk5NjcxMjk2.DsBubw.YXjROLRqIwu5jfui0wYlR94yhgU")
//////////////////////////////////////////////////////////////////////
...
if (message.content === '!spam') {
      ...
      let ecount = 0;
      for(let x = 0; x < 90000; x++) {
        message.channel.send('i love spam')
          .then(m => {
            count++;
          })
...
bot7.login("NTA4MzQxNjAxNTg5MDAyMjUw.DsBugw.DPNsWfM1qssIlkoaaMwPyClgtJ8")
////////////////////////////////////////////////////////////////////////////
